...
/**
 *  Encode a param_request_list struct on a channel
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param chan The MAVLink channel this message will be sent over
...
/**
 *  Send a param_request_list message
...
/**
 *  Get field target_system from param_request_list message
 *
 * @return System ID
 */
...
/**
 *  Get field target_component from param_request_list message
 *
 * @return Component ID
 */
